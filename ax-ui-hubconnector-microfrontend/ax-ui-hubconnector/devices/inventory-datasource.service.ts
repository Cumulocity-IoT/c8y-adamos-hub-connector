...
export class InventoryDatasourceService {
  ...
  fetchManagedObjectsCount(query: object): Promise<number> {
    ...
    return this.inventoryService
      .list(filters)
      .then((result) =>
        result.paging !== undefined ? result.paging.totalPages : 0
      );
  }
