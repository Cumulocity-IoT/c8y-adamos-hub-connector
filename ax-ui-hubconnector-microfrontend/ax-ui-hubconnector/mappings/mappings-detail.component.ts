...
import { IManufacturerIdentity } from "../shared/model/IManufacturerIdentity";
...
export class MappingsDetailComponent {
  ...
  constructor(
    ...
    this.informationText = _(
      "Ooops! It seems that there is no mapping to display."
    );
    this.loadMapping();
  }
  ...
  async loadMapping() {
    ...
    combineLatest(
      ...
      (mapping: any, manufacturerIdentities: Array<IManufacturerIdentity>) => ({
        mapping,
