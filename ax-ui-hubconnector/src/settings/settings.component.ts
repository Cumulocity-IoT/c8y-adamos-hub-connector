...
import { IHubResponse } from 'src/shared/model/IHubResponse';
...
export class SettingsComponent {
    ...
    constructor(private inventory: InventoryService, private translateService: TranslateService, private hubService: AdamosHubService) {
